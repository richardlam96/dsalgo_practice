...
class Comparable(object):
    ...
    def __init__(self, value=0):
        self.value = value
        self.default_cmp_key = "value"   # tmp fix for clients using default

    def less_than(self, other, key="value"):
        return getattr(self, key) < getattr(other, key)


    def equal_to(self, other, key="value"):
        return getattr(self, key) == getattr(other, key)


    def greater_than(self, other, key="value"):
        return getattr(self, key) > getattr(other, key)
